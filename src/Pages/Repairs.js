...
const Repairs = () => {
  ...
  return (
    <>
      <BodySection linkRoute='/contact' styleClasses='color-primary body-section--display' pageHeader='Repairs' linkText='Contact Us'>
      ...
      <BodySection linkRoute='/contact' styleClasses='background-color-primary color-white body-section--width-full' iconName={Tools} sectionTitle='Free Consultation'
                   linkText='Contact Us'>
        <p className='body-section--width-965'>You have questions.</p>
        <p className='p--top-spacing body-section--width-965'>We have answers.</p>
      ...
      <BodySection linkRoute='/our-work' styleClasses='background-color-primary color-white' sectionTitle='Our Work'
        ...
        <ImageGallerySection images={mockGalleryImageObjects1}/>
